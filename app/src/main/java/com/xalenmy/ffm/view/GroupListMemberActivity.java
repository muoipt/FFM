...
public class GroupListMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentGroup.getGroupAvatarImgPath() != null) {
...
//        if (currentUser.getUserRole() == ComonUtils.USER_ROLE_ADMIN) {
//            fab_add_new_group.setVisibility(View.VISIBLE);
//        } else {
//            fab_add_new_group.setVisibility(View.GONE);
//        }
    ...
    private void processAddNewUser() {
        ...
        if ((currentGroup.getGroupId() != -1 && currentUser.getUserEmail() == null) || (currentUser.getUserEmail() != null && currentUser.getUserStatus() == ComonUtils.USER_STATUS_NORMAL)) {
            ...
            Toast.makeText(this, "You need to be approved by admin to use this function", Toast.LENGTH_LONG).show();
        } /*else{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == ComonUtils.CODE_ADD_MEMBER_BY_ADMIN) {
        ...
        } else if (requestCode == ComonUtils.CODE_SELECT_AVATAR_FROM_GROUP_LIST) {
