...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            Bundle bundle = intent.getBundleExtra(ComonUtils.SIGN_UP_USER_FROM_ADMIN_INTENT);
            if (bundle != null) {
                groupId = bundle.getInt(ComonUtils.SIGN_UP_USER_FROM_ADMIN_BUNDLE);
                GroupDetail groupDetail = groupDetailServerControl.getGroupServerDataById(groupId);
                if (groupDetail != null) {
    ...
    private void initViewProfile() {
        ...
        if (!currentUser.getUserEmail().equals(userViewProfile.getUserEmail())) {
...
//        client.addFilter(new HTTPBasicAuthFilter("api", "key-119b4ac514d0b94afe2d755f4f7faf68"));
//        WebResource webResource = client.resource("https://api.mailgun.net/v3/sandbox441cb8f898814a5d8d4e00c1811fcd4e.mailgun.org/messages");
//        MultivaluedMapImpl formData = new MultivaluedMapImpl();
//        formData.add("from", "Mailgun Sandbox <postmaster@sandbox441cb8f898814a5d8d4e00c1811fcd4e.mailgun.org>");
//        formData.add("to", "Muoi Pham <muoipta@gmail.com>");
//        formData.add("subject", "Hello Muoi Pham");
//        formData.add("text", "Congratulations Muoi Pham, you just sent an email with Mailgun!  You are truly awesome!");
//        return webResource.type(MediaType.APPLICATION_FORM_URLENCODED).
//                post(ClientResponse.class, formData);
        Configuration configuration = new Configuration()
                .domain("sandbox441cb8f898814a5d8d4e00c1811fcd4e.mailgun.org")
                .apiKey("key-119b4ac514d0b94afe2d755f4f7faf68")
                .from("Test account", "postmaster@sandbox441cb8f898814a5d8d4e00c1811fcd4e.mailgun.org");

        Mail.using(configuration)
                .to("muoipta@gmail.com")
                .cc("xalenmy@gmail.com")
