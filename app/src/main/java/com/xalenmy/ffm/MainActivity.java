...
import com.xalenmy.ffm.eventmodel.MainEventObject;
import com.xalenmy.ffm.eventmodel.MainEventString;
import com.xalenmy.ffm.eventmodel.MainReportFragmentEventString;
import com.xalenmy.ffm.eventmodel.MainSummaryFragmentEventString;
import com.xalenmy.ffm.listener.IFabClickListener;
import com.xalenmy.ffm.listener.MainReportFragmentFabClickImpl;
import com.xalenmy.ffm.listener.MainSummaryFragmentFabClickImpl;
...
import com.xalenmy.ffm.service.SyncService;
import com.xalenmy.ffm.utils.AppConfig;
import com.xalenmy.ffm.utils.ComonUtils;
import com.xalenmy.ffm.utils.SyncUtils;
import com.xalenmy.ffm.view.AboutActivity;
import com.xalenmy.ffm.view.CategoryAddNewActivity;
import com.xalenmy.ffm.view.ChartViewActivity;
import com.xalenmy.ffm.view.GroupAddNewActivity;
import com.xalenmy.ffm.view.GroupListMemberActivity;
import com.xalenmy.ffm.view.ImageAvatarChooserActivity;
import com.xalenmy.ffm.view.ImageAvatarChooserFragment;
import com.xalenmy.ffm.view.LoginActivity;
import com.xalenmy.ffm.view.MainReportFragment;
import com.xalenmy.ffm.view.MainSearchActivity;
import com.xalenmy.ffm.view.MainSettingActivity;
import com.xalenmy.ffm.view.MainSummaryFragment;
import com.xalenmy.ffm.view.ReportAddNewActivity;
...
public class MainActivity extends AppCompatActivity
    ...
    private View navBodyView;
    private ImageView imageViewHeaderMainIcon;
...
//                refreshRecycleViewMainReport();
    ...
    private void getControlWidget() {
        ...
        navBodyView = navigationView.findViewById(R.id.nav_body_view);
...
//        userDetailControl.deleteAllUsers();
    ...
    private void processSignIn() {
        if (!internetConnected) {
            ...
            builder.setMessage("You need to connect to network to sync with server");
...
//        } else if (currentUser.getUserStatus() != 1) {
//            fab.setEnabled(false);
//            Toast.makeText(this, "You need to be approved by group admin to use this function", Toast.LENGTH_LONG).show();
//        }
...
//            });
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("You need to be approved by admin to use this function");
            AlertDialog alert = builder.create();
            alert.show();
        } else {
...
//                    Intent intent = new Intent(this, ImageAvatarChooserActivity.class);
//                    intent.setAction(ComonUtils.ACTION_AVATAR_FROM_MAIN);
//                    startActivityForResult(intent, ComonUtils.CODE_SELECT_AVATAR_FROM_MAIN);
