...
import com.muoipt.ffm.FFMApplication;
...
public class AppConfig {
    ...
    public static final String CURRENT_USER_AVATAR_IMG_PATH = "USER_AVATAR_IMG_PATH";
    ...
    public static boolean isSyncAlways = false;
    ...
    public static UserDetail getUserLogInInfor() {
        ...
        String imgAvatarPath = mSharedPreferences.getString(AppConfig.CURRENT_USER_AVATAR_IMG_PATH, null);
        ...
        return new UserDetail(id, email, pass, groupid, avatar, imgAvatarPath, status, role);
    }
    ...
    public static void saveUserInfoToSharePreference(UserDetail user) {
        ...
        if (user != null) {
            ...
            editor.putString(AppConfig.CURRENT_USER_AVATAR_IMG_PATH, user.getUserAvatarImgPath());
            ...
            editor.putString(AppConfig.CURRENT_USER_AVATAR_IMG_PATH, null);
...
//        }
    ...
    public static void setSyncAlwaysOption(boolean isSyncAlways) {
        setBooleanValueToSharePref(isSyncAlways, ComonUtils.SYNC_ALWAYS_SETTING, mContext);
    }

    public static boolean getSyncAlwaysOption() {
        return getBooleanValueToSharePref(ComonUtils.SYNC_ALWAYS_SETTING, mContext);
    }
}
